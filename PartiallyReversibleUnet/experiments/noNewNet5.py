...
PREDICT = False
####
RESTORE_ID = 2645309928119918782
RESTORE_EPOCH = 1
...
class NoNewNet(nn.Module):
    def __init__(self):
        ...
        encoderModules.append(EncoderModule(4, channels, False, True))
        encoderModules.append(EncoderModule(channels, channels * 2, True, True))
        encoderModules.append(EncoderModule(channels * 2, channels * 4, True, True))
        encoderModules.append(EncoderModule(channels * 4, channels * 8, True, True))
        encoderModules.append(EncoderModule(channels * 8, channels * 11, True, True))
        encoderModules.append(EncoderModule(channels * 11, channels * 11, True, False))
        ...
        decoderModules.append(DecoderModule(channels * 11, channels * 11, True, False))
        decoderModules.append(DecoderModule(channels * 11, channels * 8, True, True))
        decoderModules.append(DecoderModule(channels * 8, channels * 4, True, True))
        decoderModules.append(DecoderModule(channels * 4, channels * 2, True, True))
